...
CREATE TABLE `products` (
  ...
  `available_sizes` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Comma-separated list of size IDs available for this product',
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `full_name`, `department_id`, `auth_type`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('1', 'admin', '$2y$10$jVYnkYzATkFSbCgGlb4ihOr28YXaB/POOrHLr7.9/x0aEEOTQ.Hn2', NULL, NULL, NULL, 'local', 'user', '1', '2025-11-17 18:36:35', '2025-11-23 21:25:10');
